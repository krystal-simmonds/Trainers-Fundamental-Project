function displayBrands(){
    ...
    req.open("GET", "http://35.234.141.247/getAllBrands");
    req.send();
}
...
function addBrand(){
    ...
    const req = new XMLHttpRequest();
    req.open("POST", "http://35.234.141.247/addBrand");
    req.onload = () => {
        if (req.status === 200 && req.readyState === 4) {
...
function addShoe(){
    ...
    const req = new XMLHttpRequest();
    req.open("POST", "http://35.234.141.247/addShoe");
    req.onload = () => {
        if (req.status === 200 && req.readyState === 4) {
            console.log("Server Responded with: " + req.responseText);
        } else {
...
function updateShoe(){
    ...
    const req = new XMLHttpRequest();
    console.log("http://35.234.141.247/update/" + obj.shoeId)
    req.open("PUT", "http://35.234.141.247/update/" + obj.shoeId);
    req.onload = () => {
        if (req.status === 200 && req.readyState === 4) {
            console.log("Server Responded with: " + req.responseText);
        } else {
...
function deleteShoe(){
    ...
    const req = new XMLHttpRequest();
    console.log("http://35.234.141.247/delete/" + Number(obj.shoeId))
    req.open("DELETE", "http://35.234.141.247/delete/" + Number(obj.shoeId));
    req.onload = () => {
        if (req.status === 200 && req.readyState === 4) {
            console.log("Server Responded with: " + req.responseText);
        } else {
...
function deleteBrand(){
    ...
    const req = new XMLHttpRequest();
    console.log("http://35.234.141.247/deleteBrand/" + Number(obj.brandId))
    req.open("DELETE", "http://35.234.141.247/deleteBrand/" + Number(obj.brandId));
    req.onload = () => {
        if (req.status === 200 && req.readyState === 4) {
            console.log("Server Responded with: " + req.responseText);
        } else {
